...
static meow_u128 MeowHash(void *key, meow_umm Len, void *input) {
    ...
    meow_u8 *rax = (meow_u8 *)input;
    meow_u8 *rcx = (meow_u8 *)key;
    ...
    meow_u8 *Last = (meow_u8 *)input + (Len & ~0xf);
    ...
    if(Len8)
    {
        ...
        meow_u8 *LastOk = (meow_u8*)((((meow_umm)(((meow_u8 *)input)+Len - 1)) | (MEOW_PAGESIZE - 1)) - 16);
...
static void get_key(void* key, meow_umm len, void* input, meow_u128 hash) {
    meow_u128 xmm0 = hash, xmm1, xmm2, xmm3, xmm4, xmm5, xmm6, xmm7; // NOTE(casey): xmm0-xmm7 are the hash accumulation lanes
    meow_u128 xmm8, xmm9, xmm10, xmm11, xmm12, xmm13, xmm14, xmm15; // NOTE(casey): xmm8-xmm15 hold values to be appended (residual, length)
